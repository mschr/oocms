define("OoCmS/xbugfix/FilePicker", [
	"dijit",
	"dojo",
	"dojox",
	"OoCmS/xbugfix/_RollingListPane",
	"OoCmS/xbugfix/_RollingListGroupPane",
	"OoCmS/xbugfix/RollingList", 
	"dojo/i18n!dojox/widget/nls/FilePicker",
	 "dojo/text!./FilePicker/_FileInfoPane.html"
	], function(dijit,dojo,dojox,rollinglistpane, rollinglistgrouppane, rollinglist, nlsFilePicker, fileinfopaneTemplate){

//	dojo.require("dojox.widget.RollingList");

	var FileInfoPane = dojo.declare("OoCmS.xbugfix._FileInfoPane",
		[rollinglistpane], {
			...
			templateString: fileinfopaneTemplate,
	
			postMixInProperties: function(){
				this._messages = nlsFilePicker
	...
	return dojo.declare("OoCmS.xbugfix.FilePicker", [rollinglist], {
		...
		getMenuItemForItem: function(item, parentPane, children){
			var menuOptions = {
				iconClass: "dojoxDirectoryItemIcon"
			};
